...
const categoryColor = {
  ...
  "Side Hustle": "bg-lime-100 text-lime-700",
};
...
export function TransactionTable({ transactions, accountId }) {
  ...
  const handleBulkDelete = async () => {
    ...
    deleteFn({ ids: selectedIds, accountId });
  };
  ...
  return (
    ...
    className={`px-2 py-1 rounded-full text-xs font-medium ${
      categoryColor[transaction.category] || "bg-gray-100 text-gray-600"
    }`}
  >
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() =>
                            deleteFn({ ids: [transaction.id], accountId })
                          }
                        >
                          Delete
                        </DropdownMenuItem>
